namespace Si.AssetExplorer.Forms
{
    partial class FormPropertyVector
    {
        ...
        private void InitializeComponent()
        {
            ...
            kryptonNumericUpDownDefaultX = new Krypton.Toolkit.KryptonNumericUpDown();
            kryptonNumericUpDownWorkingY = new Krypton.Toolkit.KryptonNumericUpDown();
            kryptonNumericUpDownDefaultY = new Krypton.Toolkit.KryptonNumericUpDown();
            kryptonLabelWorkingX = new Krypton.Toolkit.KryptonLabel();
            kryptonLabelWorkingY = new Krypton.Toolkit.KryptonLabel();
            kryptonLabelDefaultX = new Krypton.Toolkit.KryptonLabel();
            kryptonLabelDefaultY = new Krypton.Toolkit.KryptonLabel();
            SuspendLayout();
            // 
            ...
            kryptonNumericUpDownWorkingX.TabIndex = 0;
            ...
            // 
            // kryptonNumericUpDownDefaultX
            // 
            kryptonNumericUpDownDefaultX.AllowDecimals = true;
            kryptonNumericUpDownDefaultX.DecimalPlaces = 5;
            kryptonNumericUpDownDefaultX.Increment = new decimal(new int[] { 1, 0, 0, 0 });
            kryptonNumericUpDownDefaultX.Location = new Point(40, 100);
            kryptonNumericUpDownDefaultX.Maximum = new decimal(new int[] { 100, 0, 0, 0 });
            kryptonNumericUpDownDefaultX.Minimum = new decimal(new int[] { 0, 0, 0, 0 });
            kryptonNumericUpDownDefaultX.Name = "kryptonNumericUpDownDefaultX";
            kryptonNumericUpDownDefaultX.ReadOnly = true;
            kryptonNumericUpDownDefaultX.Size = new Size(139, 22);
            kryptonNumericUpDownDefaultX.TabIndex = 11;
            kryptonNumericUpDownDefaultX.Value = new decimal(new int[] { 0, 0, 0, 0 });
            // 
            ...
            kryptonNumericUpDownWorkingY.TabIndex = 14;
            kryptonNumericUpDownWorkingY.Value = new decimal(new int[] { 0, 0, 0, 0 });
            // 
            // kryptonNumericUpDownDefaultY
            // 
            kryptonNumericUpDownDefaultY.Increment = new decimal(new int[] { 1, 0, 0, 0 });
            kryptonNumericUpDownDefaultY.Location = new Point(213, 100);
            kryptonNumericUpDownDefaultY.Maximum = new decimal(new int[] { 100, 0, 0, 0 });
            kryptonNumericUpDownDefaultY.Minimum = new decimal(new int[] { 0, 0, 0, 0 });
            kryptonNumericUpDownDefaultY.Name = "kryptonNumericUpDownDefaultY";
            kryptonNumericUpDownDefaultY.Size = new Size(120, 22);
            kryptonNumericUpDownDefaultY.TabIndex = 15;
            kryptonNumericUpDownDefaultY.Value = new decimal(new int[] { 0, 0, 0, 0 });
            // 
            ...
            kryptonLabelWorkingX.TabIndex = 16;
            ...
            kryptonLabelWorkingY.TabIndex = 17;
            kryptonLabelWorkingY.Values.Text = "Y";
            // 
            // kryptonLabelDefaultX
            // 
            kryptonLabelDefaultX.Location = new Point(12, 99);
            kryptonLabelDefaultX.Name = "kryptonLabelDefaultX";
            kryptonLabelDefaultX.Size = new Size(22, 25);
            kryptonLabelDefaultX.TabIndex = 18;
            kryptonLabelDefaultX.Values.Text = "X";
            // 
            // kryptonLabelDefaultY
            // 
            kryptonLabelDefaultY.Location = new Point(185, 99);
            kryptonLabelDefaultY.Name = "kryptonLabelDefaultY";
            kryptonLabelDefaultY.Size = new Size(22, 25);
            kryptonLabelDefaultY.TabIndex = 20;
            kryptonLabelDefaultY.Values.Text = "Y";
            // 
            // FormPropertyVector
            // 
            ...
            Controls.Add(kryptonLabelDefaultY);
            Controls.Add(kryptonLabelDefaultX);
            Controls.Add(kryptonLabelWorkingY);
            Controls.Add(kryptonLabelWorkingX);
            Controls.Add(kryptonNumericUpDownDefaultY);
            Controls.Add(kryptonNumericUpDownWorkingY);
            Controls.Add(kryptonLabelDefaultValue);
            Controls.Add(kryptonNumericUpDownDefaultX);
        ...
        private Krypton.Toolkit.KryptonNumericUpDown kryptonNumericUpDownDefaultX;
        private Krypton.Toolkit.KryptonNumericUpDown kryptonNumericUpDownWorkingY;
        private Krypton.Toolkit.KryptonNumericUpDown kryptonNumericUpDownDefaultY;
        private Krypton.Toolkit.KryptonLabel kryptonLabelWorkingX;
        private Krypton.Toolkit.KryptonLabel kryptonLabelWorkingY;
        private Krypton.Toolkit.KryptonLabel kryptonLabelDefaultX;
        private Krypton.Toolkit.KryptonLabel kryptonLabelDefaultY;
    }
}