...
namespace Si.Library
{
    public class AssetMetadata
    {
        ...
        [AssetMetadata("Throttle", "The throttle of the sprite, which determines its current speed as a percentage of its maximum speed.", PropertyEditorGroup.Momentum, PropertyEditorType.Float)]
        ...
        /// </summary>
        [AssetMetadata("Hull", "The hull strength of the sprite, representing its hit points. When this reaches 0, the sprite is destroyed.", PropertyEditorGroup.Health, PropertyEditorType.Integer)]
        public int? Hull { get; set; }

        /// <summary>
        /// Gets or sets the current shield strength of the entity, representing its defensive capabilities.
        /// </summary>
        [AssetMetadata("Shields", "The shield strength of the sprite, representing its defensive capabilities.", PropertyEditorGroup.Health, PropertyEditorType.Integer)]
        public int? Shields { get; set; }

        /// <summary>
        /// Gets or sets the bounty amount associated with the entity. This probably will not survive the early access period.
        /// </summary>
        [AssetMetadata("Bounty", "The bounty amount associated with the sprite. This probably will not survive the early access period.", PropertyEditorGroup.Health, PropertyEditorType.Integer)]
        public int? Bounty { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether munition detection is enabled (bullet detection).
        /// </summary>
        [AssetMetadata("Munition Detection", "Indicates whether munition detection (bullet detection) is enabled for the sprite.", PropertyEditorGroup.Collision, PropertyEditorType.Boolean)]
        ...
        /// monitored.</remarks>
        [AssetMetadata("Collision Detection", "Indicates whether collision detection is enabled for the sprite.", PropertyEditorGroup.Collision, PropertyEditorType.Boolean)]
        ...
        [AssetMetadata("Collision Polygon Augmentation", "The augmentation factor applied to the collision polygon, affecting its size and shape during collision detection.", PropertyEditorGroup.Collision, PropertyEditorType.Float)]
        ...
        [AssetMetadata("Munition Count", "The number of munitions available for the weapon.", PropertyEditorGroup.Munitions, PropertyEditorType.Integer)]
        ...
        [AssetMetadata("Frame Width", "The width of each frame in the sprite animation.", PropertyEditorGroup.Animation, PropertyEditorType.Integer)]
        public int? FrameWidth { get; set; }

        [AssetMetadata("Frame Height", "The height of each frame in the sprite animation.", PropertyEditorGroup.Animation, PropertyEditorType.Integer)]
        ...
        /// </summary>
        [AssetMetadata("Angle Variance", "The variance in degrees that the loaded munition will use for an initial heading angle.", PropertyEditorGroup.Munitions, PropertyEditorType.Float)]
        public float? AngleVarianceDegrees { get; set; }


        [AssetMetadata("Fire Delay", "The delay in milliseconds between each shot fired by the weapon.", PropertyEditorGroup.Munitions, PropertyEditorType.Integer)]
        ...
        /// </summary>
        [AssetMetadata("Max Lock-On Angle", "The maximum angle, in degrees, within which a target can be locked on.", PropertyEditorGroup.Weapons, PropertyEditorType.Integer)]
        public int? MaxLockOnAngle { get; set; }

        /// <summary>
        /// Gets or sets the maximum number of targets that can be locked on at once.
        /// </summary>
        [AssetMetadata("Max Locks", "The maximum number of targets that can be locked on at once.", PropertyEditorGroup.Weapons, PropertyEditorType.Integer)]
        public int? MaxLocks { get; set; }

        /// <summary>
        /// Gets or sets the minimum distance, in units, required to initiate a lock.
        /// </summary>
        [AssetMetadata("Min Lock Distance", "The minimum distance, in units, required to initiate a lock.", PropertyEditorGroup.Weapons, PropertyEditorType.Float)]
        public float? MinLockDistance { get; set; }

        /// <summary>
        /// Gets or sets the maximum distance, in units, required to initiate a lock.
        /// </summary>
        [AssetMetadata("Max Lock Distance", "The maximum distance, in units, required to initiate a lock.", PropertyEditorGroup.Weapons, PropertyEditorType.Float)]
        public float? MaxLockDistance { get; set; }

        [AssetMetadata("Explodes On Impact", "Indicates whether the munition explodes on impact.", PropertyEditorGroup.Munitions, PropertyEditorType.Boolean)]
        public bool? ExplodesOnImpact { get; set; }

        /// <summary>
        /// The viewing angle that the munition will use for seeking/locking.
        /// </summary>
        [AssetMetadata("Seeking Escape Angle", "The viewing angle that the munition will use for seeking/locking.", PropertyEditorGroup.Munitions, PropertyEditorType.Integer)]
        public int? SeekingEscapeAngleDegrees { get; set; }

        /// <summary>
        /// The viewing distance that the munition will use for seeking/locking.
        /// </summary>
        [AssetMetadata("Seeking Escape Distance", "The viewing distance that the munition will use for seeking/locking.", PropertyEditorGroup.Munitions, PropertyEditorType.Integer)]
        public int? SeekingEscapeDistance { get; set; }

        /// <summary>
        /// Rate in degrees that the munition will rotate towards it target.
        /// </summary>
        [AssetMetadata("Seeking Rotation Rate", "Rate in degrees that the munition will rotate towards it target.", PropertyEditorGroup.Munitions, PropertyEditorType.Float)]
