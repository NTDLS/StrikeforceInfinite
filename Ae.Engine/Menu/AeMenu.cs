...
namespace Ae.Engine.Menu
{
    ...
    public class AeMenu(AeEngine engine)
    {
        ...
        {
            var item = new AeSpriteMenuItem(_engine, this, _engine.Rendering.TextFormats.MenuItem, _engine.Rendering.Materials.Brushes.OrangeRed, location)
            {
                SpriteTag = key,
                Text = text,
        ...
        {
            var item = new AeSpriteMenuSelectableTextInput(_engine, this, _engine.Rendering.TextFormats.TextInputItem, _engine.Rendering.Materials.Brushes.LawnGreen, location)
            {
                SpriteTag = key,
                Text = text,
