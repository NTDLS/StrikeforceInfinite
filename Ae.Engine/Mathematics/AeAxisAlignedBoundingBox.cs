...
namespace Ae.Engine.Mathematics
{
    internal static class AeAxisAlignedBoundingBox
    {
        ...
        public static (AeVector min, AeVector max) SweptAabbForMotion(AeVector startPos, AeVector endPos, AeVector halfSize)
        {
            ...
            return (new AeVector(minX, minY), new AeVector(maxX, maxY));
        }
        ...
        public static bool AabbOverlaps((AeVector min, AeVector max) a, (AeVector min, AeVector max) b)
        {
