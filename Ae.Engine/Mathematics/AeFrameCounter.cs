...
namespace Ae.Engine.Mathematics
{
    ...
    public class AeFrameCounter
    {
        ...
        public float AverageFrameRate => AeThreading.Interlock(_samples, (obj) => obj.Items.Average());
        public float MinimumFrameRate => AeThreading.Interlock(_samples, (obj) => obj.Items.Min());
        public float MaximumFrameRate => AeThreading.Interlock(_samples, (obj) => obj.Items.Max());
