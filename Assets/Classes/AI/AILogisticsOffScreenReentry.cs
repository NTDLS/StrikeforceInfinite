...
/// </summary>
private class ExitScreen(AIStateMachine stateMachine)
    : AIStateHandler
{
...
/// </summary>
private class RotateToCenterScene(AIStateMachine stateMachine)
    : AIStateHandler
{
...
private class ApproachTarget(AIStateMachine stateMachine)
    : AIStateHandler
{
