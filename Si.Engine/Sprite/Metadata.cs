...
namespace Si.Engine.Sprite
{
    public class Metadata
    {
        ...
        [MetaData("X", "The X coordinate of the sprite's location relative to its owner.", PropertyEditorType.Decimal)]
        public float X { get; set; }
        [MetaData("Y", "The Y coordinate of the sprite's location relative to its owner.", PropertyEditorType.Decimal)]
        ...
        [MetaData("Particle Blast On Explode Amount", "Specifies the amount of particles generated when the sprite explodes.", PropertyEditorType.Range)]
        ...
        [MetaData("Screen Shake On Explode Amount", "Specifies the intensity of screen shake when the sprite explodes.", PropertyEditorType.Range)]
        public SiRange<int> ScreenShakeOnExplodeAmount { get; set; } = new SiRange<int>(1, 1000);

        [MetaData("Speed", "The speed of the sprite.", PropertyEditorType.Decimal)]
        public float Speed { get; set; } = 1f;
        [MetaData("Max Throttle", "The maximum throttle of the sprite.", PropertyEditorType.Decimal)]
        public float MaxThrottle { get; set; } = 1.0f;
        [MetaData("Throttle", "The throttle of the sprite, which determines its current speed as a percentage of its maximum speed.", PropertyEditorType.Decimal)]
        ...
        [MetaData("Collision Polygon Augmentation", "The augmentation factor applied to the collision polygon, affecting its size and shape during collision detection.", PropertyEditorType.Decimal)]
        ...
        [MetaData("Frames Per Second", "The number of frames displayed per second in the sprite animation.", PropertyEditorType.Decimal)]
        ...
        [MetaData("Sound Volume", "The volume of the sound for the sprite.", PropertyEditorType.Decimal)]
        public float SoundVolume { get; set; } = 1.0f;

        /// <summary>
        /// The variance in degrees that the loaded munition will use for an initial heading angle.
        /// </summary>
        [MetaData("Angle Variance", "The variance in degrees that the loaded munition will use for an initial heading angle.", PropertyEditorType.Decimal)]
        ...
        /// </summary>
        [MetaData("Speed Variance", "The variance expressed in decimal percentage that determines the loaded munitions initial velocity.", PropertyEditorType.Decimal)]
        ...
        /// </summary>
        [MetaData("Min Lock Distance", "The minimum distance, in units, required to initiate a lock.", PropertyEditorType.Decimal)]
        public float MinLockDistance { get; set; } = 50;
        /// <summary>
        /// Gets or sets the maximum distance, in units, required to initiate a lock.
        /// </summary>
        [MetaData("Max Lock Distance", "The maximum distance, in units, required to initiate a lock.", PropertyEditorType.Decimal)]
        ...
        /// </summary>
        [MetaData("Seeking Rotation Rate", "Rate in degrees that the munition will rotate towards it target.", PropertyEditorType.Decimal)]
