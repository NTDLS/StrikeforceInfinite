...
namespace Si.Engine
{
    ...
    public class SiEngine
    {
        ...
        public delegate void InitializationEvent(SiEngine engine);
        public event InitializationEvent? OnInitializationComplete;

        public delegate void ShutdownEvent(SiEngine engine);
        ...
        /// </summary>
        public SiEngine(SiEngineExecutionMode executionMode = SiEngineExecutionMode.SharedEngineContent)
        {
        ...
        /// management with another instance of the engine (the "shared engine") that is running in shared engine content mode.
        /// </summary>
        public SiEngine(ManagedLobby lobby, SiEngine sharedEngine, SiEngineExecutionMode executionMode)
        {
        ...
        public SiEngine(Control drawingSurface, SiEngineExecutionMode executionMode, Size? sizeOverride = null)
        {
            ExecutionMode = executionMode;
